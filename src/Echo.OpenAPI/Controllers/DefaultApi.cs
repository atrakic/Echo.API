...
namespace Echo.OpenAPI.Controllers
{
    ...
    public class DefaultApiController : ControllerBase
    {
        ...
        [Route("/messages")]
        [ValidateModelState]
        [SwaggerOperation("SearchMessages")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<Message>), description: "OK")]
        public virtual IActionResult SearchMessages([FromQuery (Name = "query")]string query)
        {
        ...
        [ValidateModelState]
        [SwaggerOperation("StoreMessage")]
        [SwaggerResponse(statusCode: 200, type: typeof(Message), description: "Success")]
        public virtual IActionResult StoreMessage([FromBody]Message message)
        {
